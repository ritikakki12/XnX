...
bot = telebot.TeleBot('7874156385:AAGGGEyL7rEhl95dmKGVjWISE6JiAHAuo1c')

# Admin user IDs
admin_id = ["1604629264","6437994839"]
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                response = f"𝗔𝘁𝘁𝗮𝗰𝗸 𝗰𝗼𝗺𝗽𝗹𝗲𝘁𝗲𝗱 ✅ Please On Of Your Internet And Kill Enemy, Send Feedback 🚀"
        else:
